...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('usd', models.DecimalField(decimal_places=4, max_digits=10, verbose_name='USD')),
                ('eur', models.DecimalField(decimal_places=4, max_digits=10, verbose_name='EUR')),
                ('rub', models.DecimalField(decimal_places=4, max_digits=10, verbose_name='RUB')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value_from', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Value')),
                ('created_at', models.DateField(auto_now_add=True)),
                ('from_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_from', to='wallet.account', verbose_name='From')),
                ('to_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers_to', to='wallet.account', verbose_name='To')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incomes', to='wallet.incomecategory', verbose_name='Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='costs', to='wallet.costcategory', verbose_name='Category')),
